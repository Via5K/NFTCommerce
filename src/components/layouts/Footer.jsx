...
export default function Footer() {
	...
	return (
		<footer className="text-primary py-5 w-full mx-auto px-3 sm:px-6 shadow-2xl bg-black/5 backdrop-blur-3xl">
			<div className="max-w-lg sm:mx-auto sm:text-center">
				<Image src="/token.svg" width={120} height={130} alt="NFT" className="sm:mx-auto" />
				<p className="leading-relaxed mt-2 text-[15px]">
					NFT in e-commerce decentralized application developed using React, Next, Tailwind CSS, Solidity, Truffle, Metamask, Goerli Testnet, etc.
				</p>
			</div>
			...
			<div className="mt-8 items-center justify-between sm:flex">
				<div className="mt-4 sm:mt-0">&copy; 2023 NFT in Commerce All rights reserved.</div>
